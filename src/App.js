    ...
    <div className="bg-gray-900 text-white min-h-screen font-sans">
      ...
      <section className="flex flex-col items-center justify-center h-screen text-center px-4">
        <motion.img 
          src={profilePic} 
          alt="Profile" 
          className="w-40 h-40 rounded-full border-4 border-blue-400 mb-6 shadow-lg"
          initial={{ scale: 0 }}
          animate={{ scale: 1 }}
      ...
      <section className="px-8 py-16 bg-gray-800">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            { title: "Yoga Posture Detection & Correction", desc: "Real-time web app with KNN & ml5.js, Top 10 Hackathon Finalist.", link: "https://github.com/thanishka220/Yoga-Pose-Correction-main.git" },
